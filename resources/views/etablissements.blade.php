...
@section('content')
                ...
                <div class="card mb-4 mx-4">
                    <div class="card-header pb-0">
                        <div class="d-flex flex-row justify-content-between">
                            <div>
                                <h5 class="mb-0">Etablissements</h5>
                            </div>
                            <div>
                                <button type="button" href="#" class="btn bg-gradient-info btn-sm mb-0"
                                    data-bs-toggle="modal" data-bs-target="#ajouterModal">+&nbsp; Etablissement</button>
                            </div>
                    ...
                    <div class="card-body px-0 pt-0 pb-2">
                        <div class="table-responsive p-0 table-data">
                            <table class="table align-items-center mb-0 cell-border compact hover" data-page-length='6'
                                ...
                                <tbody>
                                    @foreach ($etabs as $item)
                                        <tr>
                                            <td class="ps-4">
                                                <p class="text-xs font-weight-bold mb-0">{{ $item->id }}</p>
                                            </td>
                                            <td class="text-left">
                                                <p class="text-xs font-weight-bold mb-0">{{ $item->nomEtablissement }}</p>
                                            </td>
                                            <td class="text-left">
    ...
    @include('components.Modals.Etabs.add')
    @include('components.Modals.Etabs.edit')
    @include('components.Modals.Etabs.delete')
@endsection
...
@section('scripts')
    ...
    <script src="{{ asset('js/Etablissements/edit.js') }}"></script>
@endsection
