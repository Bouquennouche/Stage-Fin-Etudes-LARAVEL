...
@section('content')
                ...
                <div class="card mb-4 mx-4">
                    <div class="card-header pb-0">
                        <div class="d-flex flex-row justify-content-between">
                            <div>
                                <h5 class="mb-0">Domaines</h5>
                            </div>
                            <div>
                                <button type="button" href="#" class="btn bg-gradient-info btn-sm mb-0"
                                    data-bs-toggle="modal" data-bs-target="#ajouterModal">+&nbsp; Domaine</button>
                            </div>
                                ...
                                <tbody>
                                    @foreach ($domaines as $item)
                                        <tr>
                                            ...
                                            <td class="text-left">
                                                <p class="text-xs font-weight-bold mb-0">{{ $item->nomDomaine }}</p>
                                            </td>
                                            <td class="text-left">
                                                <p class="text-xs font-weight-bold mb-0">{{ $item->specialite }}</p>
                                            </td>
                                            <td class="">
    ...
    @include('components.Modals.Domaines.addDomaine')
    @include('components.Modals.Domaines.editDomaine')
    @include('components.Modals.Domaines.deleteDomaine')
@endsection
...
@section('scripts')
    ...
    <script src="{{ asset('js/Domaines/edit.js') }}"></script>
@endsection
