            ...
            <div class="modal-body p-0">
                <div class="card card-plain">
                    <div class="card-header pb-0 text-left">
                        <h3 class="font-weight-bolder text-info text-gradient">Modifier un domaine</h3>
                        <p class="mb-0"></p>
                    </div>
                    <div class="card-body pb-3">
                        <form role="form text-left" method="POST" action="{{ route('update-domaine') }}"
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="nomDomaine" id="editNom" required class="form-control"
                                    onkeyup="validateInputEdit('editNom')">
                                <div class="invalid-feedback">Veuillez enter un nom valide.</div>
                            </div>
                            <div class="col-md-12 mt-2">
                                <label>Spécialité</label>
                                <input type="text" name="specialite" id="editSp" required class="form-control"
                                    onkeyup="validateInputEdit('editSp')">
                                <div class="invalid-feedback">Veuillez enter un nom de specialite valide.</div>
                            </div>
