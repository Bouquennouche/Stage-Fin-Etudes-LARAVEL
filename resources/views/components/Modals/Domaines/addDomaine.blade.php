            ...
            <div class="modal-body p-0">
                <div class="card card-plain">
                    <div class="card-header pb-0 text-left">
                        <h3 class="font-weight-bolder text-info text-gradient">Ajouter un domaine</h3>
                        <p class="mb-0"></p>
                    </div>
                    <div class="card-body pb-3">
                        <form role="form text-left" method="POST" action="/storeDomaine" enctype="multipart/form-data"
                            onsubmit="return validateForm()">
                            @csrf

                            <div class="col-md-12">
                                <label>Nom Domaine</label>
                                <input type="text" name="nomDomaine" id="nomDomaine" required class="form-control"
                            ...
                            <div class="col-md-12 mt-2">
                                ...
                                <input type="text" name="specialite" id="specialite" required class="form-control"
                                    onkeyup="validateInput('specialite')">
